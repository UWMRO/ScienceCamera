...
class TakeImage(wx.Panel): ## first tab; with photo imaging
    def __init__(self, parent):
        ...
        als.AddLinearSpacer(self.vbox, 10 )
        #self.vbox.Add(self.expTime, proportion=0, flag=wx.ALIGN_CENTER)

        '''
        als.AddLinearSpacer(self.vbox, 25)
        self.vbox.Add(self.expValue, flag=wx.ALIGN_CENTER)
        als.AddLinearSpacer(self.vbox, 25)
        self.vbox.Add(self.expButton, flag=wx.ALIGN_CENTER)
        als.AddLinearSpacer(self.vbox, 25)
        self.vbox.Add(ac.Exposure(self), flag=wx.ALIGN_CENTER)
        '''
        als.AddLinearSpacer(self.vbox, 10)
        self.vbox.Add(ac.Exposure(self), proportion=1, flag=wx.EXPAND)
